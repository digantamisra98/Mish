...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="L",
        help="log frequency (default: 500)",
    )
    parser.add_argument(
        "--resume",
        default="",
...
def main():
    ...
    criterion, optimizer = get_loss_optim(
        model, device, args.lr, args.momentum, args.weight_decay
    )
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        delta = (end_time - start_time).total_seconds() // 60.0
            ...
            wandb.log(
                {
                    ...
                    "Batch Training time (ms)": batch_time.val * 10,
                    "Batch Data time (ms)": data_time.val * 10,
                    "Batch Training loss": losses.val,
                    "Batch Training Top-1 accuracy": top1.val,
